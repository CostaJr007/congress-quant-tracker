...
@app.get("/api/analyze/suspicious")
...
def api_enrich():
    ...
    return {"status": "completed", "sectors": sector_stats, "photos_filled": photos, "rescore": rescore}
